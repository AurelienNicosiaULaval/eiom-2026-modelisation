...
Cette étape n'utilise encore aucun résultat du test. Elle entraîne les trois pipelines exactement comme ils auraient été déployés après le choix.
...
Les valeurs manuelles doivent correspondre aux valeurs calculées par `brier_class()`: environ 0,212, 0,207 et 0,205. Cette vérification confirme que la probabilité utilisée correspond au niveau de l'événement.
