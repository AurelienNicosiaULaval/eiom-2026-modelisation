...
::: {.notes}
2 minutes. Demander ce que ce changement peut modifier: une référence naïve, la calibration et parfois les mesures de classement.
:::
...
::: {.notes}
2 minutes. Faire classer oralement les variables permises et interdites.
:::
...
::: {.notes}
2 minutes. Rappeler que la régression logistique sert ici de référence sérieuse, pas de modèle faible.
:::
...
::: {.notes}
2 minutes. Demander quel critère domine si une règle doit être expliquée ligne par ligne.
:::
