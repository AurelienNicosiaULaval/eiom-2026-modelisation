...
Votre équipe doit ouvrir le jeu test, évaluer les probabilités produites par le modèle et choisir un seuil adapté à un mandat analytique. Vous terminerez par une fiche modèle de six phrases.

Durée: 25 minutes.

Production: une matrice de confusion, une comparaison de seuils, un diagnostic de calibration, une comparaison du score de Brier et la fiche modèle.
...
5. interpréter un score de Brier par comparaison avec une règle de référence;
6. choisir un seuil à partir d'un mandat, et non par automatisme.
...
## 6. Comparer l'erreur des probabilités
...
5. Interpréter le score de Brier sans le comparer à une référence.
...
- Le score de Brier du modèle est comparé à la règle constante.
- La petite taille du test est mentionnée.
- La fiche ne transforme pas l'exercice en règle réelle de sauvetage.
